...
%   Version: 1.0, 13 October 2015.
    ...
    properties
        ...
        DropStringFcn;
        %handle for wrapper GUI component
        hUIControl;
    end
    ...
    methods
        function obj = dndcontrol(Parent,hContainer,DropFileFcn,DropStringFcn)
        ...
        %   callback functions for dropping of files and text.
            ...
            obj.hUIControl = hContainer;
            
            % Set callback functions
            if nargin >=3, obj.DropFileFcn = DropFileFcn; end 
            if nargin >=4, obj.DropStringFcn = DropStringFcn; end
        end
