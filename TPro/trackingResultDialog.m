function varargout = trackingResultDialog(varargin)
    ...
    % Last Modified by GUIDE v2.5 19-Jun-2017 02:57:07
...
function popupmenu2_Callback(hObject, eventdata, handles)
    ...
    % Hints:  returns popupmenu2 contents as cell array
...
function showFrameInAxes(hObject, handles, frameNum)
    ...
    hold on;
    plot(sharedInst.Y{t}(:),sharedInst.X{t}(:),'or'); % the actual tracking
